	...
	public function brand($slug, Request $request)
{
    ...
    public function category($slug, Request $request)
    {
        ...
        $category_banner = Banner::where(['status' => 1, 'category_id' => 2])->latest()->first();
        $products = $products->paginate(24);
        return view('frontEnd.layouts.pages.category', compact('category', 'products', 'subcategories', 'min_price', 'max_price', 'soldShow', 'category_banner'));
    }
    ...
    public function livesearch(Request $request)
    {
        ...
        if (empty($keyword) && empty($request->category)) {
            return '';
        }
