...
@section('content')
    <section class="product-section">
        <div class="container">
            ...
            @if(isset($category_banner) && $category_banner)
            <div class="row mb-3">
                <div class="col-sm-12">
                    <a href="{{ $category_banner->link }}">
                        <img src="{{ asset($category_banner->image) }}" alt="{{ $category->name }} Banner" class="img-fluid w-100 rounded" style="border-radius: 8px;" loading="lazy" />
                    </a>
                </div>
            </div>
            @endif
