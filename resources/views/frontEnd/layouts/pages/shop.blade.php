            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-2 mb-md-0">
                    <div class="category-breadcrumb d-flex align-items-center" style="font-size: 14px; gap: 8px; color: #64748b;">
                        <a href="{{ route('home') }}" style="color: #64748b; text-decoration: none; font-weight: 500;">Home</a>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center justify-content-md-end gap-3">
                        <span style="font-size: 13.5px; color: #64748b; white-space: nowrap;">
                            Showing <strong style="color: #0f172a;">{{ $products->firstItem() ?? 0 }}-{{ $products->lastItem() ?? 0 }}</strong> of <strong style="color: #0f172a;">{{ $products->total() }}</strong> Results
                        </span>
                    ...
                    <div class="shop-product-card">
                        ...
                        <div>
                            ...
                            <div style="font-size: 11px; color: #94a3b8; font-weight: 600; text-transform: uppercase; margin-bottom: 4px; letter-spacing: 0.5px;">
                                {{ $value->category ? $value->category->name : 'PET SUPPLIES' }}
                            </div>

                            <!-- Product Title -->
                            <a href="{{ route('product', $value->slug) }}" class="shop-title-link" title="{{ $value->name }}">
                                {{ $value->name }}
                            </a>
                            ...
                            <div style="margin-bottom: 16px; display: flex; align-items: baseline; gap: 8px;">
                                ...
                                @if($value->old_price && $value->old_price > $value->new_price)
                                    <del style="font-size: 13px; color: #94a3b8;">৳ {{ number_format($value->old_price, 2) }}</del>
                                @endif
                            </div>
                        </div>
                        ...
                        <div>
                            @if (!$value->prosizes->isEmpty() || !$value->procolors->isEmpty())
                                <a href="{{ route('product', $value->slug) }}" class="shop-btn-cart">
