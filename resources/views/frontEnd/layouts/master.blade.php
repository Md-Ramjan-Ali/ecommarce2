                                ...
                                <div class="catagory_menu_v2" style="display: flex; align-items: center; justify-content: space-between; height: 46px;">
                                    ...
                                    <ul class="nav_menu_left" style="display: flex; align-items: center; margin: 0; padding: 0; list-style: none; gap: 22px; height: 100%;">
                                        ...
                                        <li style="height: 100%; display: flex; align-items: center; list-style: none;">
                                            ...
                                            <a href="{{ route('customer.account') }}" class="nav_main_link" style="color: #ffffff !important; font-weight: 700; font-size: 13.5px; text-transform: uppercase; text-decoration: none; white-space: nowrap; letter-spacing: 0.3px;">
                                                MY ACCOUNT
                                            </a>
                                            @else
                                            <a href="{{ route('customer.login') }}" class="nav_main_link" style="color: #ffffff !important; font-weight: 700; font-size: 13.5px; text-transform: uppercase; text-decoration: none; white-space: nowrap; letter-spacing: 0.3px;">MY ACCOUNT</a>
                                            @endif
                                        </li>
                                    </ul>
                    ...
                    <div class="footer-v2__block">
                        ...
                        <ul class="footer-v2__links" style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 13.5px;">
                            ...
                            @foreach($pages as $page)
                                <li><a href="{{ route('page', ['slug' => $page->slug]) }}" style="color: #9ca3af; text-decoration: none; transition: color 0.2s;"><i class="fa-solid fa-angle-right me-1" style="font-size: 11px;"></i> {{ $page->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="footer-v2__links" style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 13.5px;">
                            ...
                            @if(isset($pagesright) && count($pagesright) > 0)
                                @foreach($pagesright as $key => $value)
                                    <li><a href="{{ route('page', ['slug' => $value->slug]) }}" style="color: #9ca3af; text-decoration: none; transition: color 0.2s;"><i class="fa-solid fa-angle-right me-1" style="font-size: 11px;"></i> {{ $value->name }}</a></li>
                                @endforeach
                            @else
