                    ...
                    <div class="main_slider owl-carousel">
                        <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="slider-item">
                                <a href="<?php echo e($value->link ?? '#'); ?>" style="display: block; height: 100%; width: 100%;">
                                    <img src="<?php echo e(asset($value->image)); ?>" alt="Slider Banner" />
                                </a>
                            </div>
            ...
            <div class="col-sm-12">
                <div class="sec_title">
                    <h3 class="section-title-header">
                        ...
                        <a href="<?php echo e(route('shop')); ?>" class="view_more_btn">
                            ...
                            <div class="product_item wist_item wow zoomIn"
                                ...
                                <div class="product_item_inner">
                                    ...
                                    <div class="pro_img" style="text-align: center; margin-bottom: 14px; height: 190px !important; overflow: hidden !important; border-radius: 6px !important; width: 100% !important;">
                                        <a href="<?php echo e(route('product', $value->slug)); ?>" style="display: block !important; width: 100% !important; height: 100% !important;">
                ...
                <div class="blog-home-card">
                    ...
                    <div class="blog-home-img">
                        <a href="<?php echo e(route('blog.details', $blog->slug)); ?>">
                            <img src="<?php echo e(asset($blog->image ? $blog->image : 'public/no-image.png')); ?>"
                    ...
                    <div class="blog-home-content">
                        <div class="blog-home-meta">
                            <i class="far fa-calendar-alt me-1"></i> <?php echo e($blog->created_at ? $blog->created_at->format('d M Y') : ''); ?>

                            <span class="mx-1">|</span>
                            <i class="far fa-eye me-1"></i> <?php echo e($blog->views ?? 0); ?>
                        ...
                        <p class="blog-home-desc">
                            <?php echo e(Str::limit($blog->short_description, 100)); ?>
