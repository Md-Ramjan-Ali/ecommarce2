...
.product_item_inner .pro_img>a,
.featured-card-item .pro_img>a {
    display: block !important;
...
.featured-card-item:hover .pro_img img {
    transform: scale(1.08) !important;
    transition: opacity 0.5s ease, transform 0.8s cubic-bezier(0, 0, 0.44, 1.18) !important;
}
...
.nav_menu_left li.nav_item_dropdown {
    position: relative !important;
}
...
.brands__dropdown:hover > .brands-dropdown-menu {
    display: block !important;
}
...
.nav_menu_left a.nav_main_link:hover,
