                        ...
                        <div class="col-md-7">
                            <div class="status-panel">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="status" value="1" <?php if($contact->status==1): ?> checked <?php endif; ?> style="width: 3.5em; height: 1.7em; cursor:pointer;">
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Programming capture\New folder\E-Commerce2\ecommerce2\resources\views/backEnd/contact/index.blade.php ENDPATH**/ ?>