...
<html lang="en">
  <head>
    ...
    <style>
      /* =========================================================
         🌟 PREMIUM MODERN CUSTOM SCROLLBAR DESIGN
         ========================================================= */
      html {
      ...
      .visit-site-btn:hover {
        ...
        color: #ffffff !important;
        box-shadow: 0 4px 14px rgba(30, 115, 190, 0.35) !important;
      ...
      .noti-icon-badge {
        ...
        box-shadow: 0 0 0 2px #0f172a, 0 0 10px rgba(239, 68, 68, 0.6) !important;
        ...
        <div class="container-fluid">
          <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown d-none d-lg-inline-block">
              <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="fullscreen" href="#" title="Toggle Fullscreen">
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="mobile-inline-logo-item">
              <a href="<?php echo e(url('admin/dashboard')); ?>" class="mobile-inline-logo-link">
                <img src="<?php echo e(asset(isset($generalsetting->white_logo) ? $generalsetting->white_logo : 'public/backEnd/assets/images/logo.png')); ?>" alt="" />
              </a>
            </li>
