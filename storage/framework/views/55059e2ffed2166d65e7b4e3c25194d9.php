                                        ...
                                        <ul style="display: flex; align-items: center; gap: 14px; list-style: none; margin: 0; padding: 0;">
                                            <!-- User Account Button -->
                                             <li class="header-account-item" style="position: relative; list-style: none;">
                                                 <a href="<?php echo e(Auth::guard('customer')->check() ? route('customer.account') : route('customer.login')); ?>" style="display: flex; align-items: center; gap: 7px; font-weight: 600; font-size: 13.5px; color: #334155 !important; text-decoration: none; padding: 9px 18px; border-radius: 50px; background: #f8fafc; border: 1px solid #cbd5e1; transition: all 0.2s; white-space: nowrap !important;">
