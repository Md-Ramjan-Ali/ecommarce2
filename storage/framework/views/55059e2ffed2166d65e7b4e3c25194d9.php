                                ...
                                <div class="catagory_menu_v2" style="display: flex; align-items: center; justify-content: space-between; height: 46px;">
                                    ...
                                    <ul class="nav_menu_left" style="display: flex; align-items: center; margin: 0; padding: 0; list-style: none; gap: 22px; height: 100%;">
                                                ...
                                                <ul style="list-style: none; margin: 0; padding: 6px 0;">
                                                    ...
                                                    <li style="list-style: none;">
                                                        <a href="<?php echo e(route('brand.products', $brand->slug)); ?>" style="padding: 8px 16px; display: flex; align-items: center; gap: 8px; color: #333333 !important; font-size: 13px; font-weight: 500; text-decoration: none; white-space: nowrap;">
                                                            ...
                                                            <img src="<?php echo e(asset($brand->image)); ?>" alt="<?php echo e($brand->name); ?>" style="width: 20px; height: 20px; object-fit: contain;">
                                                            <?php endif; ?>
                                        ...
                                        <li style="height: 100%; display: flex; align-items: center; list-style: none;">
                                            ...
                                            <a href="<?php echo e(route('customer.account')); ?>" class="nav_main_link" style="color: #ffffff !important; font-weight: 700; font-size: 13.5px; text-transform: uppercase; text-decoration: none; white-space: nowrap; letter-spacing: 0.3px;">
                                                MY ACCOUNT
                                            </a>
                                            <?php else: ?>
                                            <a href="<?php echo e(route('customer.login')); ?>" class="nav_main_link" style="color: #ffffff !important; font-weight: 700; font-size: 13.5px; text-transform: uppercase; text-decoration: none; white-space: nowrap; letter-spacing: 0.3px;">MY ACCOUNT</a>
                                            <?php endif; ?>
                                        </li>
                                    </ul>
                    ...
                    <div class="footer-v2__block">
                        ...
                        <ul class="footer-v2__links" style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 13.5px;">
                            ...
                            <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('page', ['slug' => $page->slug])); ?>" style="color: #9ca3af; text-decoration: none; transition: color 0.2s;"><i class="fa-solid fa-angle-right me-1" style="font-size: 11px;"></i> <?php echo e($page->name); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="footer-v2__block">
                        ...
                        <ul class="footer-v2__links" style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 10px; font-size: 13.5px;">
                            ...
                            <?php if(isset($pagesright) && count($pagesright) > 0): ?>
                                <?php $__currentLoopData = $pagesright; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(route('page', ['slug' => $value->slug])); ?>" style="color: #9ca3af; text-decoration: none; transition: color 0.2s;"><i class="fa-solid fa-angle-right me-1" style="font-size: 11px;"></i> <?php echo e($value->name); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
