...
<div class="container-fluid py-4">
    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-md-6 text-md-end mt-3 mt-md-0">
            <a href="<?php echo e(route('socialmedias.create')); ?>" class="btn btn-primary rounded-pill px-4 shadow-sm fw-bold">
                    ...
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table table-pro mb-0 w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="text-muted fw-bold">#<?php echo e($loop->iteration); ?></span></td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="fw-bold text-dark d-block" style="font-size: 15px;"><?php echo e($value->title); ?></span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end align-items-center">
                                            ...
                                            <a href="<?php echo e(route('socialmedias.edit',$value->id)); ?>" 
                                               class="btn-action btn-edit-modern shadow-sm ms-1" 
                                               title="Edit Platform">
                                                <i class="fa fa-pencil-alt"></i>
                                            </a>

                                            <form method="post" action="<?php echo e(route('socialmedias.destroy')); ?>" class="d-inline ms-1" id="delete-form-<?php echo e($value->id); ?>">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" value="<?php echo e($value->id); ?>" name="hidden_id">
                                                <button type="button" class="btn-action btn-delete-modern shadow-sm delete-confirm" 
                                                        title="Remove Platform"
                                                        data-form-id="delete-form-<?php echo e($value->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Programming capture\New folder\E-Commerce2\ecommerce2\resources\views/backEnd/socialmedia/index.blade.php ENDPATH**/ ?>